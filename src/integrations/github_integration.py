...
class GitHubIntegration(MCPIntegration):
    ...
    async def search(self, query: str, **kwargs) -> List[Dict[str, Any]]:
        ...
        if not self.client:
            return [self._format_error(Exception("GitHub client not configured"), "search")]

        try:
            search_type = kwargs.get('type', 'repositories')  # repositories, issues, code
    ...
    async def get_item(self, item_id: str) -> Dict[str, Any]:
        ...
        if not self.client:
            return self._format_error(Exception("GitHub client not configured"), "get_item")
    ...
    async def create_item(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not self.client:
            return self._format_error(Exception("GitHub client not configured"), "create_item")
    ...
    async def update_item(self, item_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not self.client:
            return self._format_error(Exception("GitHub client not configured"), "update_item")
    ...
    def publish_documentation(self,
        ...
        try:
            ...
            try:
                ...
                return self.update_item(f"{repository}/file/{file_path}", {
                    'content': content,
    ...
    def search_repository_content(self, repository: str, topic: str) -> List[Dict[str, Any]]:
                ...
                try:
                    ...
                    if isinstance(contents, list):
                        for content in contents:
                            if content.type == 'file' and content.name.endswith(('.md', '.txt', '.rst')):
