...
class ConfluenceIntegration(MCPIntegration):
    ...
    def _setup_client(self):
        ...
        if not all([self.settings.confluence_server_url, self.settings.jira_username, self.settings.confluence_api_token]):
            self.client = None
            return
    ...
    async def search(self, query: str, **kwargs) -> List[Dict[str, Any]]:
        ...
        if not self.client:
            return [self._format_error(Exception("Confluence client not configured"), "search")]
    ...
    async def get_item(self, item_id: str) -> Dict[str, Any]:
        ...
        if not self.client:
            return self._format_error(Exception("Confluence client not configured"), "get_item")
    ...
    async def create_item(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not self.client:
            return self._format_error(Exception("Confluence client not configured"), "create_item")
    ...
    async def update_item(self, item_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not self.client:
            return self._format_error(Exception("Confluence client not configured"), "update_item")
        ...
        try:
            if self.client:
                ...
                if existing_page:
                    ...
                    return self.update_item(existing_page['id'], {
