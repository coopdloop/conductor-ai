...
class CreateDocumentationSkill(Skill):
    ...
    def parameters(self) -> List[SkillParameter]:
        return [
            SkillParameter(
                ...
                options=["procedure", "troubleshooting", "api_guide", "runbook", "technical_spec", "user_guide"]
            ),
            SkillParameter(
                name="title",
                type="string",
    ...
    async def execute(
        ...
        try:
            ...
            elif parameters["context_source"] == "workflow_id" and parameters.get("workflow_id"):
    ...
    def _generate_documentation_content(
        ...
        for section in sections:
            if section == "overview":
                content_parts.extend(self._generate_overview_section(doc_type, source_data))
            elif section == "steps":
                content_parts.extend(self._generate_steps_section(doc_type, source_data))
            elif section == "troubleshooting":
                content_parts.extend(self._generate_troubleshooting_section(doc_type, source_data))
            elif section == "references":
                content_parts.extend(self._generate_references_section(doc_type, source_data, context))

        return "\n".join(content_parts)

    def _generate_overview_section(self, doc_type: str, source_data: Dict[str, Any]) -> List[str]:
    ...
    def _generate_steps_section(self, doc_type: str, source_data: Dict[str, Any]) -> List[str]:
    ...
    def _generate_troubleshooting_section(self, doc_type: str, source_data: Dict[str, Any]) -> List[str]:
    ...
    def _generate_references_section(self, doc_type: str, source_data: Dict[str, Any], context: Dict[str, Any]) -> List[str]:
...
class UpdateDocumentationSkill(Skill):
        ...
        try:
            ...
            if orchestrator and hasattr(orchestrator, 'doc_processor'):
                ...
                if update_type == "append":
                    ...
                    new_content = self._apply_correction(existing_doc["content"], content)
    ...
    def _replace_section(self, existing_content: str, section_name: str, new_content: str) -> str:
